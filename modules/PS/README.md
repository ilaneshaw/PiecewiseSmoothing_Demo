...
• PS: can be run separately, using the runPS.R file and provides 1DPS and 2DPS predictions and maps.
...
• plotResults.Rmd: This code produces the figures for the Piecewise Smoothing manuscript can be found in examinePS. Run the SETUP sections, then run the desired sections separately.
